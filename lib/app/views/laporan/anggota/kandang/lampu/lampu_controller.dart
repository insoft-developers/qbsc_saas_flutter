...
class LampuController extends GetxController {
  ...
  // FETCH DATA
  // =========================
  Future<void> fetchLampu({bool loadMore = false}) async {
    ...
    try {
      ...
      if (body['success'] == true) {
        ...
        final fetchedData = listData
            .map((json) => LampuModel.fromJson(json))
            .toList();

        lampuList.addAll(fetchedData);
