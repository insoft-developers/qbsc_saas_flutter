...
import 'package:qbsc_saas/app/views/laporan/anggota/kandang/suhu/suhu_controller.dart';
...
class SuhuDetail extends StatelessWidget {
  ...
  const SuhuDetail({super.key, required this.data});
                ...
                children: [
                  _card(
                    ...
                    children: [
                      ...
                      _row('Suhu Kandang', '${data.temperature} C'),
                    ],
                  ),
