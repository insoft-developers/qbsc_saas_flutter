...
import 'package:qbsc_saas/app/views/laporan/anggota/kandang/kipas/kipas_model.dart';
...
class KipasController extends GetxController {
  ...
  // FETCH DATA
  // =========================
  Future<void> fetchKipas({bool loadMore = false}) async {
    ...
    try {
      ...
      if (body['success'] == true) {
        ...
        final fetchedData = listData
            .map((json) => KipasModel.fromJson(json))
            .toList();

        kipasList.addAll(fetchedData);
